...
* [VIM](vim/vim/README.md)
  ...
  * [Backspace Options](vim/vim/backspace-options.md)
  * [Beginning And End Of Previous Change](vim/vim/beginning-and-end-of-previous-change.md)
  * [The Black Hole Register](vim/vim/the-black-hole-register.md)
  * [Blank Lines Above And Below](vim/vim/blank-lines-above-and-below.md)
  * [Breaking The Undo Sequence](vim/vim/breaking-the-undo-sequence.md)
  * [Buffer Time Travel](vim/vim/buffer-time-travel.md)
  * [Build And Install A Go Program](vim/vim/build-and-install-a-go-program.md)
  * [Case-Aware Substitution With vim-abolish](vim/vim/case-aware-substitution-with-vim-abolish.md)
  * [Case-Insensitive Substitution](vim/vim/case-insensitive-substitution.md)
  * [Center The Cursor](vim/vim/center-the-cursor.md)
  * [Check For An Executable](vim/vim/check-for-an-executable.md)
  * [Check Your Current Color Scheme](vim/vim/check-your-current-color-scheme.md)
  * [Clear Out The Jump List](vim/vim/clear-out-the-jump-list.md)
  * [Close All Other Splits](vim/vim/close-all-other-splits.md)
  * [Close All Other Windows](vim/vim/close-all-other-windows.md)
  * [Close the Current Buffer](vim/vim/close-the-current-buffer.md)
  * [Coerce The Current Filetype](vim/vim/coerce-the-current-filetype.md)
  * [Coercing Casing With vim-abolish](vim/vim/coercing-casing-with-vim-abolish.md)
  * [Configure FZF To Use fd For File Finding](vim/vim/configure-fzf-to-use-fd-for-file-finding.md)
  * [Count the Number of Matches](vim/vim/count-the-number-of-matches.md)
  * [Create A New Directory In netrw](vim/vim/create-a-new-directory-in-netrw.md)
  * [Create A New File In A New Directory](vim/vim/create-a-new-file-in-a-new-directory.md)
  * [Creating Non-Existent Directories](vim/vim/creating-non-existent-directories.md)
  * [Default netrw To Tree Liststyle](vim/vim/default-netrw-to-tree-liststyle.md)
  * [Delete Every Other Line](vim/vim/delete-every-other-line.md)
  * [Delete Lines That Match A Pattern](vim/vim/delete-lines-that-match-a-pattern.md)
  * [Delete To The End Of The Line](vim/vim/delete-to-the-end-of-the-line.md)
  * [Deleting Buffers In BufExplorer](vim/vim/deleting-buffers-in-bufexplorer.md)
  * [Deleting Directories Of Files From netrw](vim/vim/deleting-directories-of-files-from-netrw.md)
  * [Detect If You Are On A Mac](vim/vim/detect-if-you-are-on-a-mac.md)
  * [Difference Between :wq and :x](vim/vim/difference-between-wq-and-x.md)
  * [Display Word Count Stats](vim/vim/display-word-count-stats.md)
  * [Edges Of The Selection](vim/vim/edges-of-the-selection.md)
  * [Edit A File At A Specific Line Number](vim/vim/edit-a-file-at-a-specific-line-number.md)
  * [Edit A File Starting On The Last Line](vim/vim/edit-a-file-starting-on-the-last-line.md)
  * [End Of The Word](vim/vim/end-of-the-word.md)
  * [Escaping Terminal-Mode In An Nvim Terminal](vim/vim/escaping-terminal-mode-in-an-nvim-terminal.md)
  * [Filter Lines Through An External Program](vim/vim/filter-lines-through-an-external-program.md)
  * [Fix The Spelling Of A Word](vim/vim/fix-the-spelling-of-a-word.md)
  * [Fold A Visual Selection And Expand It Back](vim/vim/fold-a-visual-selection-and-expand-it-back.md)
  * [For When That Escape Key Is Hard To Reach](vim/vim/for-when-that-escape-key-is-hard-to-reach.md)
  * [Format Long Lines To Text Width](vim/vim/format-long-lines-to-text-width.md)
  * [From Ruby Variables To JavaScript Variables](vim/vim/from-ruby-variables-to-javascript-variables.md)
  * [Generate and Edit Rails Migration](vim/vim/generate-and-edit-rails-migration.md)
  * [Get The pid Of The Session](vim/vim/get-the-pid-of-the-session.md)
  * [Go Back To The Previous Window](vim/vim/go-back-to-the-previous-window.md)
  * [Go To File With Line Number](vim/vim/go-to-file-with-line-number.md)
  * [Grepping Through The Vim Help Files](vim/vim/grepping-through-the-vim-help-files.md)
  * [Head of File Name](vim/vim/head-of-file-name.md)
  * [Help For Non-Normal Mode Features](vim/vim/help-for-non-normal-mode-features.md)
  * [Highlighting Search Matches](vim/vim/highlighting-search-matches.md)
  * [Horizontal to Vertical and Back Again](vim/vim/horizontal-to-vertical-and-back-again.md)
  * [Increment All The Numbers](vim/vim/increment-all-the-numbers.md)
  * [Incremental Searching](vim/vim/incremental-searching.md)
  * [Interact With The Alternate File](vim/vim/interact-with-the-alternate-file.md)
  * [Interactive Buffer List](vim/vim/interactive-buffer-list.md)
  * [Joining Lines Together](vim/vim/joining-lines-together.md)
  * [Jump Back To The Latest Jump Position](vim/vim/jump-back-to-the-latest-jump-position.md)
  * [Jump Between And Stage Git Hunks With Fugitive](vim/vim/jump-between-and-stage-git-hunks-with-fugitive.md)
  * [Jump To Matching Pair](vim/vim/jump-to-matching-pair.md)
  * [Jump To The Next Misspelling](vim/vim/jump-to-the-next-misspelling.md)
  * [List All Buffers](vim/vim/list-all-buffers.md)
  * [List Of Plugins](vim/vim/list-of-plugins.md)
  * [Load A Directory Of Files Into The Buffer List](vim/vim/load-a-directory-of-files-into-the-buffer-list.md)
  * [Make Directories For The Current File](vim/vim/make-directories-for-the-current-file.md)
  * [Marks Across Vim Sessions](vim/vim/marks-across-vim-sessions.md)
  * [Match The Beginning And End Of Words](vim/vim/match-the-beginning-and-end-of-words.md)
  * [Moving To A Specific Line](vim/vim/moving-to-a-specific-line.md)
  * [Navigate To The Nth Column On A Line](vim/vim/navigate-to-the-nth-column-on-a-line.md)
  * [Navigating By Blank Lines](vim/vim/navigating-by-blank-lines.md)
  * [NETRW Listing Styles](vim/vim/netrw-listing-styles.md)
  * [Next Modified Buffer](vim/vim/next-modified-buffer.md)
  * [Normal Node Binding To Just Quit](vim/vim/normal-mode-binding-to-just-quit.md)
  * [Open A Tag In A Split Window](vim/vim/open-a-tag-in-a-split-window.md)
  * [Open an Unnamed Buffer](vim/vim/open-an-unnamed-buffer.md)
  * [Open FZF Result In A Split](vim/vim/open-fzf-result-in-a-split.md)
  * [Open Routes File With vim-rails](vim/vim/open-routes-file-with-vim-rails.md)
  * [Open The Directory Of The Current File](vim/vim/open-the-directory-of-the-current-file.md)
  * [Open The Fugitive Git Summary Window](vim/vim/open-the-fugitive-git-summary-window.md)
  * [Open The Gemfile](vim/vim/open-the-gemfile.md)
  * [Open The Latest Rails Migration](vim/vim/open-the-latest-rails-migration.md)
  * [Open The Selected Lines In GitHub With Gbrowse](vim/vim/open-the-selected-lines-in-github-with-gbrowse.md)
  * [Open Vim To A Tag Definition](vim/vim/open-vim-to-a-tag-definition.md)
  * [Opening a URL](vim/vim/opening-a-url.md)
  * [Opening Man Pages In Vim](vim/vim/opening-man-pages-in-vim.md)
  * [Paste A Register From Insert Mode](vim/vim/paste-a-register-from-insert-mode.md)
  * [Preventing Typos with Abbreviations](vim/vim/preventing-typos-with-abbreviations.md)
  * [Previous Buffer](vim/vim/previous-buffer.md)
  * [Previous Visual Selection](vim/vim/previous-visual-selection.md)
  * [Print The Relative Path Of The Current File](vim/vim/print-the-relative-path-of-the-current-file.md)
  * [Print Version Information](vim/vim/print-version-information.md)
  * [Quick File Info](vim/vim/quick-file-info.md)
  * [Quick Man Pages](vim/vim/quick-man-pages.md)
  * [Quick Quickfix List Navigation](vim/vim/quick-quickfix-list-navigation.md)
  * [Quickly Fix A Misspelled Word](vim/vim/quickly-fix-a-misspelled-word.md)
  * [Quickly Switch To A Buffer By Number](vim/vim/quickly-switch-to-a-buffer-by-number.md)
  * [Quit When There Is An Argument List](vim/vim/quit-when-there-is-an-argument-list.md)
  * [Re-indenting Your Code](vim/vim/reindenting-your-code.md)
  * [Read In The Contents Of A Rails File](vim/vim/read-in-the-contents-of-a-rails-file.md)
  * [Rename A File Through netrw](vim/vim/rename-a-file-through-netrw.md)
  * [Rename Current File](vim/vim/rename-current-file.md)
  * [Repeat The Previous Change](vim/vim/repeat-the-previous-change.md)
  * [Repeating Characters](vim/vim/repeating-characters.md)
  * [Replace A Character](vim/vim/replace-a-character.md)
  * [Reset Target tslime Pane](vim/vim/reset-target-tslime-pane.md)
  * [Reverse A Group Of Lines](vim/vim/reverse-a-group-of-lines.md)
  * [Rotate Everything By 13 Letters](vim/vim/rotate-everything-by-13-letters.md)
  * [Rotate The Orientation Of Split Windows](vim/vim/rotate-the-orientation-of-split-windows.md)
  * [Running Bundle With vim-bundler](vim/vim/running-bundle-with-vim-bundler.md)
  * [Scrolling Relative to the Cursor](vim/vim/scrolling-relative-to-the-cursor.md)
  * [Search Backward Through A File](vim/vim/search-backward-through-a-file.md)
  * [Searching For Hex Digits](vim/vim/searching-for-hex-digits.md)
  * [Select Several Results From An FZF Search](vim/vim/select-several-results-from-an-fzf-search.md)
  * [Set End Of Line Markers](vim/vim/set-end-of-line-markers.md)
  * [Set Your Color Scheme](vim/vim/set-your-color-scheme.md)
  * [Set Up Vim-Plug With Neovim](vim/vim/set-up-vim-plug-with-neovim.md)
  * [Setting Filetype With Modelines](vim/vim/setting-filetype-with-modelines.md)
  * [Show All Syntax Highlighting Rules](vim/vim/show-all-syntax-highlighting-rules.md)
  * [Show Matching Entries For Help](vim/vim/show-matching-entries-for-help.md)
  * [Specify The Line Height Of The Quick Fix Window](vim/vim/specify-the-line-height-of-the-quick-fix-window.md)
  * [Split Different](vim/vim/split-different.md)
  * [Split The Current Window](vim/vim/split-the-current-window.md)
  * [Splitting For New Files](vim/vim/splitting-for-new-files.md)
  * [Source Original vimrc When Using Neovim](vim/vim/source-original-vimrc-when-using-neovim.md)
  * [Swap Occurrences Of Two Words](vim/vim/swap-occurrences-of-two-words.md)
  * [Swapping Split Windows](vim/vim/swapping-split-windows.md)
  * [Tabs To Spaces](vim/vim/tabs-to-spaces.md)
  * [The Vim Info File](vim/vim/the-vim-info-file.md)
  * [Toggle Absolute And Relative Paths In BufExplorer](vim/vim/toggle-absolute-and-relative-paths-in-bufexplorer.md)
  * [Toggling Syntax Highlighting](vim/vim/toggling-syntax-highlighting.md)
  * [Turning Off Search Highlighting](vim/vim/turning-off-search-highlighting.md)
  * [Unloading A Buffer](vim/vim/unloading-a-buffer.md)
  * [Use Active Window With BufExplorer](vim/vim/use-active-window-with-bufexplorer.md)
  * [Use The Terminal Inside A Vim Session](vim/vim/use-the-terminal-inside-a-vim-session.md)
  * [Using vim-surround With A Visual Selection](vim/vim/using-vim-surround-with-a-visual-selection.md)
  * [Verbose Commits With Fugitive](vim/vim/verbose-commits-with-fugitive.md)
  * [View Commit History of a File](vim/vim/view-commit-history-of-a-file.md)
  * [Viewing Man Pages with man.vim](vim/vim/viewing-man-pages-with-man-vim.md)
  * [Vim Without The Extras](vim/vim/vim-without-the-extras.md)
